...
(() => {
  ...
  function buildFeatureFlags(args) {
    return {
      ...
      fullConfig: parseBool(args.full, true),
  ...
  // src/generated/service_domains.ts
  var ANTHROPIC_DOMAIN_SUFFIXES, OPENAI_DOMAIN_SUFFIXES;
  var init_service_domains = __esm({
    "src/generated/service_domains.ts"() {
      "use strict";
      ANTHROPIC_DOMAIN_SUFFIXES = [
        "anthropic.com",
        "clau.de",
        "claude.ai",
        "claude.com",
  ...
  var buildDomainSuffixRules, baseRules;
  var init_rules = __esm({
    "src/rules.ts"() {
      "use strict";
      init_constants();
      init_service_domains();
      buildDomainSuffixRules = (domains, proxyGroup) => domains.map((domain) => `DOMAIN-SUFFIX,${domain},${proxyGroup}`);
      baseRules = [
